...
*Примечание для агентов: держите эти README в синхронизации с `src/main.tsx`, `src/index.css`, `scripts/*` и `.github/workflows/*`. Исправляйте устаревшие комментарии. Правила для AI-агентов: [AGENT.md](./AGENT.md).*
...
Для работы используются **Bun** (JS/TS) и **uv** (Python).
